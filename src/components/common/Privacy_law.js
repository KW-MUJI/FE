  ...
  return (
    <div className={styles.contents}>
      ...
      <div className={styles.law}>
        <h4>제1조(목적)</h4>
        <p>
          광운 무인양품(이하 '회사'라고 함)은 회사가 제공하고자 하는 서비스(이하
        ...
        <ol>
          <li>
            ...
            홈페이지 첫 화면 또는 첫 화면의 연결화면을 통해 본 방침을 공개하고
            있습니다.
          </li>
          <li>
        ...
        <p>
          회사는 이용자가 회사 서비스에 대한 회원가입을 위하여 다음과 같은
          정보를 수집합니다.
        </p>
        <ol>
        ...
        <p>1. 필수 수집 정보: 이메일 주소 및 이름</p>

        <h4>제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</h4>
        <p>
          회사는 이용자의 서비스 이용에 따른 통계·분석 및 부정이용의 확인·분석을
          위하여 다음과 같은 정보를 수집합니다. (부정이용이란 회원탈퇴 후
          재가입, 상품구매 후 구매취소 등을 반복적으로 행하는 회사가 제공하는
          할인쿠폰, 이벤트 혜택 등의 경제적 이익을 불·편법적으로 수취하는 행위,
          이용약관 등에 금지하고 있는 행위, 명의도용 등의 불·편법행위를
          말합니다.)
        </p>
        <ol>
          <li>
        ...
        <ol>
          ...
          <li>
            홈페이지 서비스를 이용하기 위해 이용자가 개인정보를 입력하는 방식
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            홈페이지 서비스(팀프로젝트 모집 등) 이용에서 신청자의 정보를
            생성자에게 보내는 경우 및 생성자가 신청자에게 팀원 선정 정보를
            보내는 경우
          </li>
        </ol>
        ...
        <ol>
          <li>
            ...
            기타 관련 법령에 의한 정보 보호 사유에 따라(보유 및 이용기간 참조)
        ...
        <ol>
          ...
          <ol className={styles.koreanList}>
            <li>
              ...
              있는 수신자와 거래한 것과 동일한 종류의 재화 등에 대한 영리목적의
              광고성 정보를 전송하는 경우
            </li>
            <li>
              「방문판매 등에 관한 법률」에 따라 전화권유판매자가 육성으로
          ...
          <li>
            회사는 오후 9시부터 그 다음 날 오전 8시까지의 시간에 전자적
          ...
          <ol className={styles.koreanList}>
            ...
            <li>
              광고성 정보 전송자의 신원을 감추기 위해 전송 출처를 감추기 위한
              각종 조치
            </li>
            <li>
        ...
        <p>
          ...
          개인정보를 회사가 수집하는 “개인정보의 보유 및 이용기간”에 명시된 바에
        ...
        <p>
          이용자의 비밀번호는 일방항 암호화하여 저장 및 관리되고 있으며,
        ...
        <ol>
          ...
          <li>
            회사는 민감한 개인정보(본인확인 정보 등)를 암호화 통신 등을 통하여
        ...
        <ol>
          ...
          <li>
            ...
            포함)·처리위탁·보관(이하 "이전"이라 함)하려면 이용자의 동의를
            받습니다. 다만, 본조 제3항 각 호의 사항 모두를 개인정보보호법 등
            관계 법규에 따라 공개하거나 전자우편 등 대통령령으로 정하는 방법에
            따라 이용자에게 알린 경우에는 개인정보 처리위탁·보관에 따른
            동의절차를 거치지 아니할 수 있습니다.
          </li>
          <li>
            회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항
            모두를 이용자에게 고지합니다.
          </li>
          <ol className={styles.koreanList}>
            <li>이전되는 개인정보 항목</li>
          ...
          <li>
            회사는 본조 제2항 본문에 따른 동의를 받아 개인정보를 국외로 이전하는
        ...
        <ol>
          ...
          <ol>
            ...
            <ol>
              ...
              <li>
                전화번호: 02-940-5595, 010-4321-8812, 010-5262-0670,
                010-6425-0302, 010-8882-0206
              </li>
