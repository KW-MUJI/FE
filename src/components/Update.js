      ...
      <div className={styles.main_container}>
            ...
            {imgSrc ? (
              <>
                ...
                >
                  ...
                  >
                    <path
                      d="M10 8.58579L13.4142 5.17157L14.8284 6.58579L11.4142 10L14.8284 13.4142L13.4142 14.8284L10 11.4142L6.58579 14.8284L5.17157 13.4142L8.58579 10L5.17157 6.58579L6.58579 5.17157L10 8.58579Z"
                      fill="#000000"
                    />
                  </svg>
                </button>
              ...
              >
                ...
                <g clipPath="url(#clip0_2279_1339)">
                  <rect
                    width="23.6739"
                    height="23.6739"
                    transform="translate(5.77148 4.4292)"
                    fill="white"
                  />
                  <path
                    d="M28.4589 23.1713C28.4589 23.6945 28.251 24.1963 27.8811 24.5663C27.5111 24.9363 27.0093 25.1441 26.4861 25.1441H8.73064C8.20741 25.1441 7.70562 24.9363 7.33564 24.5663C6.96566 24.1963 6.75781 23.6945 6.75781 23.1713V12.3207C6.75781 11.7975 6.96566 11.2957 7.33564 10.9257C7.70562 10.5558 8.20741 10.3479 8.73064 10.3479H12.6763L14.6491 7.38867H20.5676L22.5404 10.3479H26.4861C27.0093 10.3479 27.5111 10.5558 27.8811 10.9257C28.251 11.2957 28.4589 11.7975 28.4589 12.3207V23.1713Z"
                    fill="#4C4C4C"
                  />
                  <path
                    d="M17.6084 21.1985C19.7875 21.1985 21.554 19.4319 21.554 17.2528C21.554 15.0737 19.7875 13.3072 17.6084 13.3072C15.4292 13.3072 13.6627 15.0737 13.6627 17.2528C13.6627 19.4319 15.4292 21.1985 17.6084 21.1985Z"
                    fill="#4C4C4C"
                  />
                </g>
                <defs>
        ...
        <div className={styles.input}>
          ...
          <input
            ...
            onChange={onChangeForm}
          />
          <p id={styles.pw_condition}>
            숫자 최소 1개, 대소문자 최소 1개, 특수문자 최소 1개 (총 5자 - 11자)
          </p>
        </div>
        <div className={styles.input}>
        ...
        <div>
          <input
            ...
            id="file-input"
          />
          <button className={styles.secession} onClick={handleDeleteClick}>
            탈퇴하기
          </button>
          <button className={styles.submit} onClick={handleUpdate}>
            수정
          </button>
        </div>
