...
const Notice = () => {
    ...
    return (<div className={styles.notice_container}>
        ...
        <div className={styles.category}>
            ...
            <button onClick={() => handleChangeCategory(null)} className={selectedCategory === null ? styles.select_category : styles.nonselect_category}>전체</button>
            <button onClick={() => handleChangeCategory(0)} className={selectedCategory === 0 ? styles.select_category : styles.nonselect_category}>일반</button>
            <button onClick={() => handleChangeCategory(1)} className={selectedCategory === 1 ? styles.select_category : styles.nonselect_category}>학사</button>
            <button onClick={() => handleChangeCategory(2)} className={selectedCategory ===2 ? styles.select_category : styles.nonselect_category}>학생</button>
            <button onClick={() => handleChangeCategory(3)} className={selectedCategory === 3 ? styles.select_category : styles.nonselect_category}>봉사</button>
            <button onClick={() => handleChangeCategory(4)} className={selectedCategory === 4 ? styles.select_category : styles.nonselect_category}>등록/장학</button>
            <button onClick={() => handleChangeCategory(5)} className={selectedCategory === 5 ? styles.select_category : styles.nonselect_category}>입학</button>
            <button onClick={() => handleChangeCategory(6)} className={selectedCategory === 6 ? styles.select_category : styles.nonselect_category}>시설</button>
            <button onClick={() => handleChangeCategory(7)} className={selectedCategory === 7 ? styles.select_category : styles.nonselect_category}>병무</button>
            <button onClick={() => handleChangeCategory(8)} className={selectedCategory === 8 ? styles.select_category : styles.nonselect_category}>외부</button>
            <button onClick={() => handleChangeCategory(9)} className={selectedCategory === 9 ? styles.select_category : styles.nonselect_category}>국제교류</button>
            <button onClick={() => handleChangeCategory(10)} className={selectedCategory ===10 ? styles.select_category : styles.nonselect_category}>국제학생</button>
        </div>
