            ...
            <div className={styles.main_container}>
                <div className={styles.first_container}>
                    <div className={styles.info}>
                        {imgSrc ? (
                            <img src={imgSrc} alt="Profile" width="110" height="110" style={{ borderRadius: '50%', margin:'50px 60px' }} />
                        ) : (
                            <svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: '50%' , margin:'50px 60px'}}>
                        ...
                        <h1 onClick={goTocheckPw}>{profile.username}<span>님 &gt;</span></h1>
                        <div className={styles.my}>
                            <p onClick={goToTeam}>MY 팀플</p>
                            <p onClick={goToMyTeam}>MY 모집 팀플</p>
                            <p onClick={goTosurvey}>MY 설문</p>
                        </div>
                        <button onClick={handleLogoutClick} className={styles.logout}>로그아웃</button>
                    </div>
                </div>
                            ...
                            {myRecruitTeams.length > 0 ? (
                                myRecruitTeams.map((item, index) => (
                                    <div key={index} className={styles.team}>
                                        <span className={styles.dot}></span>
                                        {item.name}
                                        <span className={styles.dday}>{item.onGoing ? '진행 중' : '마감'}</span>
                                    </div>
                                ))
                            ) : (
                                <div className={styles.team}>
