    ...
    return (
        <div className={styles.contents}>
            ...
            <div className={styles.law}>
                ...
                <h4>제3조(본 방침의 공개)</h4>
                <ol>
                    <li>회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 회사 홈페이지 첫 화면 또는 첫 화면의 연결화면을 통해 본 방침을 공개하고 있습니다.</li>
                ...
                <ol>
                    ...
                    <li>회사는 제1항에 따라 본 방침을 개정하는 경우 다음 각 호 하나 이상의 방법으로 공지합니다.</li>
                    <ol className={styles.koreanList}>
                ...
                <h4>제5조(회원 가입을 위한 정보)</h4>
                <p>회사는 이용자가 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.</p>
                <ol>
                    <li>필수 수집 정보: 이메일 주소, 비밀번호, 이름 및 닉네임</li>
                    <li>선택 수집 정보: 프로필 사진, 포트폴리오</li>
                </ol>

                <h4>제6조(본인 인증을 위한 정보)</h4>
                <p>회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.</p>
                <ol>
                    <li>필수 수집 정보: 이메일 주소</li>
                </ol>

                <h4>제7조(회사 서비스 제공을 위한 정보)</h4>
                ...
                <h4>제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</h4>
                <p>회사는 이용자의 서비스 이용에 따른 통계·분석 및 부정이용의 확인·분석을 위하여 다음과 같은 정보를 수집합니다. (부정이용이란 회원탈퇴 후 재가입, 상품구매 후 구매취소 등을 반복적으로 행하는 회사가 제공하는 할인쿠폰, 이벤트 혜택 등의 경제적 이익을 불·편법적으로 수취하는 행위, 이용약관 등에 금지하고 있는 행위, 명의도용 등의 불·편법행위를 말합니다.)</p>
                <ol>
                    <li>필수 수집 정보: 서비스 이용기록, 쿠키, 접속지 정보 및 기기정보</li>
                </ol>

                <h4>제9조(개인정보 수집 방법)</h4>
                <p>회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.</p>
                <ol>
                    <li>이용자가 회사의 홈페이지에서 자신의 개인정보를 입력하는 방식</li>
                    <li>어플리케이션 등 회사가 제공하는 홈페이지 외의 서비스를 통해 이용자가 자신의 개인정보를 입력하는 방식</li>
                    <li>홈페이지 서비스를 이용하기 위해 이용자가 개인정보를 입력하는 방식</li>
                </ol>
                ...
                <ol>
                    ...
                    <li>홈페이지 서비스(팀프로젝트 모집 등) 이용에서 신청자의 정보를 생성자에게 보내는 경우 및 생성자가 신청자에게 팀원 선정 정보를 보내는 경우</li>
                </ol>

                <h4>제11조(개인정보의 보유 및 이용기간)</h4>
                <ol>
                ...
                <h4>제12조(법령에 따른 개인정보의 보유 및 이용기간)</h4>
                <p>회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.</p>
                <ol>
                    <li>전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보 및 보유기간</li>
                    <ol className={styles.koreanList}>
                ...
                <h4>제13조(개인정보의 파기원칙)</h4>
                <p>회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.</p>

                <h4>제14조(개인정보파기절차)</h4>
                <ol>
                    <li>이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보 보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기 되어집니다.</li>
                    <li>회사는 파기 사유가 발생한 개인정보를 개인정보보호 책임자의 승인절차를 거쳐 파기합니다.</li>
                </ol>

                <h4>제15조(개인정보파기방법)</h4>
                <p>회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며, 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.</p>

                <h4>제16조(광고성 정보의 전송 조치)</h4>
                <ol>
                    <li>회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다.</li>
                    <ol className={styles.koreanList}>
                        <li>회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우, 거래가 종료된 날로부터 6개월 이내에 회사가 처리하고 있는 수신자와 거래한 것과 동일한 종류의 재화 등에 대한 영리목적의 광고성 정보를 전송하는 경우</li>
                        <li>「방문판매 등에 관한 법률」에 따라 전화권유판매자가 육성으로 수신자에게 개인정보의 수집출처를 고지하고 전화권유를 하는 경우</li>
                    </ol>
                    ...
                    <li>회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음의 사항 등을 광고성 정보에 구체적으로 밝힙니다.</li>
                    <ol className={styles.koreanList}>
                        <li>회사명 및 연락처</li>
                        <li>회사명 및 연락처</li>
                    </ol>
                    <li>회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음 각 호의 어느 하나에 해당하는 조치를 하지 않습니다.</li>
                    <ol className={styles.koreanList}>
                        ...
                        <li>광고성 정보 전송자의 신원을 감추기 위해 전송 출처를 감추기 위한 각종 조치</li>
                        <li>영리목적의 광고성 정보를 전송할 목적으로 수신자를 기망하여 회신을 유도하는 각종 조치</li>
                    </ol>
                </ol>

                <h4>제17조(개인정보 조회 및 수정동의 철회)</h4>
                <ol>
                ...
                <ol>
                    ...
                    <li>타인의 개인정보를 도용한 회원가입의 경우 이용자 자격을 상실하거나 관련 개인정보 보호법에 의해 처벌받을 수 있습니다.</li>
                    <li>이용자는 전자우편주소, 비밀번호 등에 대한 보안을 유지할 책임이 있으며 제3자에게 이를 양도하거나 대여할 수 없습니다.</li>

                </ol>


                <h4>제20조(회사의 개인정보 관리)</h4>
                <p>회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조, 훼손 등이 되지 아니하도록 안전성을 확보하기 위하여 필요한 기술적·관리적 보호대책을 강구하고 있습니다.</p>


                <h4>제21조(삭제된 정보의 처리)</h4>
                <p>회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보를 회사가 수집하는 “개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.</p>


                <h4>제22조(비밀번호의 암호화)</h4>
                <p>이용자의 비밀번호는 일방항 암호화하여 저장 및 관리되고 있으며, 개인정보의 확인, 변경은 비밀번호를 알고 있는 본인에 의해서만 가능합니다.</p>

                <h4>제23조(해킹 등에 대비한 대책)</h4>
                <ol>
                    ...
                    <li>회사는 민감한 개인정보(본인확인 정보 등)를 암호화 통신 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 하고 있습니다.</li>
                </ol>

                <h4>제24조(개인정보 처리 최소화 및 교육)</h4>
                <p>회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보 처리자에 대한 교육 등 관리적 조치를 통해 법령 및 내부방침 등의 준수를 강조하고 있습니다.</p>

                <h4>제25조(개인정보 유출 등에 대한 조치)</h4>
                ...
                <h4>제26조(개인정보 유출 등에 대한 조치의 예외)</h4>
                <p>회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한 사유가 있는 경우에는 회사의 홈페이지에 30일 이상 게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수 있습니다.</p>

                <h4>제27조(국외 이전 개인정보의 보호)</h4>
                <ol>
                    <li>회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지 않습니다.</li>
                    <li>회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를 포함)·처리위탁·보관(이하 "이전"이라 함)하려면 이용자의 동의를 받습니다. 다만, 본조 제3항 각 호의 사항 모두를 개인정보보호법 등 관계 법규에 따라 공개하거나 전자우편 등 대통령령으로 정하는 방법에 따라 이용자에게 알린 경우에는 개인정보 처리위탁·보관에 따른 동의절차를 거치지 아니할 수 있습니다.</li>
                    <li>회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항 모두를 이용자에게 고지합니다.</li>
                    <ol className={styles.koreanList}>
                        <li>이전되는 개인정보 항목</li>
                        <li>개인정보가 이전되는 국가, 이전일시 및 이전방법</li>
                        <li>개인정보를 이전받는 자의 성명(법인인 경우 그 명칭) 및 정보관리 책임자의 연락처</li>
                        <li>개인정보를 이전받는 자의 개인정보 이용목적 및 보유·이용 기간</li>
                    </ol>
                    <li>회사는 본조 제2항 본문에 따른 동의를 받아 개인정보를 국외로 이전하는 경우 개인정보보호법 대통령령 등 관계법규에서 정하는 바에 따라 보호조치를 합니다.</li>
                </ol>

                <h4>제28조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h4>
                <ol>
                    <li>회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정보 자동 수집장치(이하 '쿠키')를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 웹브라우저(PC 및 모바일을 포함)에게 보내는 소량의 정보이며 이용자의 저장장치에 저장되기도 합니다.</li>
                ...
                <h4>제30조(회사의 개인정보 보호 책임자 지정)</h4>
                <ol>
                    <li>회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.</li>
                    <ol>
                        <li>개인정보 보호 책임자</li>
                        <ol>
                            <li>성명: 최지훈, 김정윤, 조은향, 김민곤</li>
                            <li>직책: 광운 무인양품 팀원(광운대학교 참빛설계)</li>
                            <li>전화번호: 02-940-5595, 010-4321-8812, 010-5262-0670, 010-6425-0302, 010-8882-0206</li>
                            <li>이메일: kwumuji@gmail.com</li>
                        </ol>

                    </ol>
                </ol>

                <h4>제31조(권익침해에 대한 구제방법)</h4>
                <ol>
                    ...
                    <li>개인정보 보호법 제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.</li>
                    <ol className={styles.koreanList}>
            ...
            <h4>부칙</h4>
            <p>제1조 본 방침은 2024.09.01.부터 시행됩니다.</p>
