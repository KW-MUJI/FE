            ...
            <div key={index} className={styles.team_list}>
                <div className={styles.team_header}>
                    ...
                    <div className={styles.list_option}>
                        <button id={styles.edit}>수정</button>
                        <button id={styles.start}>팀플시작</button>
                        <button id={styles.cancel}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
